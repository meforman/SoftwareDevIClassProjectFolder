...
public class SpellCheckerGUI extends Application {
		...
		checkButton.setOnAction (new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				for (String fileWord : fileWords) {// iterates the to be checked file for bad words
					checkForTheWord(fileWord, dictionaryWords, badWords);
				}
	 ...
	 */
	public static StringBuilder checkForTheWord(String theWord, ArrayList<String> listToCheck, StringBuilder badWords) {
